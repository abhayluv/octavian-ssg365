...
<body class="onboarding-whitebg">

        <header class="onboarding-header mob-just-between">
         <div class="header-logo"><a href=""><img src="{{ asset('images/logo-white.png')}}" alt=""></a></div>
        </header>
