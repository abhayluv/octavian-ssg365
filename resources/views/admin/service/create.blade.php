                        ...
                        <div class="profile-form-section">
                            <div class="profile-form-part">
                                <div class="setting-middle-section">
                                    <form class="items-center" action="{{ route('admin.manage_service.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="setting-form-section">
                                            <div class="setting-row">
                                                ...
                                                <div class="set-inputfield">
                                                    <input type="text" name="service_name" value="{{ old('service_name') }}" class="form-control prmcd" placeholder="Service Name">
                                                    @error('service_name')
                                                ...
                                                <div class="set-inputfield">
                                                    <div class="d-flex">
                                                        <div class="form-check me-4">
                                                            <input class="form-check-input me-2" type="radio" name="status" value="1" id="active" checked>
                                                            <label class="form-check-label" for="active">
                                                                {{ __('Active') }}
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input me-2" type="radio" name="status" value="0" id="deactive">
