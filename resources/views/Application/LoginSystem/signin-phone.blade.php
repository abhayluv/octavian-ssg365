            ...
            <form action="signup-verification.html" class="form-d-flex h-100">
                <div class="form-detail">
                    <div class="mb-3">
                        ...
                        <div class="inputicon"><input type="umber" class="form-control" placeholder="phone number">
                            <div class="forminput-icon"><img src="{{ asset('assets/images/phone-call-icon.svg') }}" alt=""></div>
                        </div>
                        <div class="form-message-text">A code will be sent to your phone number.</div>
