            ...
            <form action="signup-verification.html" class="form-d-flex h-100">
                <div class="form-detail">
                    <div class="mb-3">
                        ...
                        <div class="inputicon"><input type="email" class="form-control" placeholder="name@example.com">
                            <div class="forminput-icon"><img src="{{ asset('assets/images/email-icon.svg') }}" alt=""></div>
                        </div>
