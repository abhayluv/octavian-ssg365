 ...
 * Original file: /npm/timedaterangepicker@3.1.0/timedaterangepicker.js
 *
...
! function(t, e) {
	...
	} else t.timedaterangepicker = e(t.moment, t.jQuery)
}(this, function(t, e) {
	var timeslot='<span><a href="#">09:00am</a></span><span><a href="#">10:00am</a></span><span><a href="#">11:00am</a></span><span><a href="#">12:00am</a></span><span><a href="#">01:00pm</a></span><span><a href="#">02:00pm</a></span><span><a href="#">03:00pm</a></span><span><a href="#">04:00pm</a></span>';
	var a = function(a, i, s) {
		if (this.parentEl = "body", this.element = e(a), this.startDate = t().startOf("day"), this.endDate = t().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = t().subtract(100, "year").format("YYYY"), this.maxYear = t().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
			...
			}, this.callback = function() {}, this.isShowing = !1, this.leftCalendar = {}, this.rightCalendar = {}, "object" == typeof i && null !== i || (i = {}), "string" == typeof(i = e.extend(this.element.data(), i)).template || i.template instanceof e || (i.template = '<div class="daterangepicker timedaterangepicker clsdaterangewidth"><div class="ranges"></div><div class="drp-calendar cls-calendar-flex left"><div class="calendar-table"></div><div class="calendar-time"></div><div class="calendar-time-right">'+timeslot+'</div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'), this.parentEl = i.parentEl && e(i.parentEl).length ? e(i.parentEl) : e(this.parentEl), this.container = e(i.template).appendTo(this.parentEl), "object" == typeof i.locale && ("string" == typeof i.locale.direction && (this.locale.direction = i.locale.direction), "string" == typeof i.locale.format && (this.locale.format = i.locale.format), "string" == typeof i.locale.separator && (this.locale.separator = i.locale.separator), "object" == typeof i.locale.daysOfWeek && (this.locale.daysOfWeek = i.locale.daysOfWeek.slice()), "object" == typeof i.locale.monthNames && (this.locale.monthNames = i.locale.monthNames.slice()), "number" == typeof i.locale.firstDay && (this.locale.firstDay = i.locale.firstDay), "string" == typeof i.locale.applyLabel && (this.locale.applyLabel = i.locale.applyLabel), "string" == typeof i.locale.cancelLabel && (this.locale.cancelLabel = i.locale.cancelLabel), "string" == typeof i.locale.weekLabel && (this.locale.weekLabel = i.locale.weekLabel), "string" == typeof i.locale.customRangeLabel)) {
		...
		"function" == typeof s && (this.callback = s), this.timePicker || (this.startDate = this.startDate.startOf("day"), this.endDate = this.endDate.endOf("day"), this.container.find(".calendar-time").hide()), this.timePicker && this.autoApply && (this.autoApply = !1), this.autoApply && this.container.addClass("auto-apply"), "object" == typeof i.ranges && this.container.addClass("show-ranges"), this.singleDatePicker && (this.container.addClass("single"), this.container.find(".drp-calendar.left").addClass("single"), this.container.find(".drp-calendar.left").show(), this.container.find(".drp-calendar.right").hide(), !this.timePicker && this.autoApply && this.container.addClass("auto-apply")), (void 0 === i.ranges && !this.singleDatePicker || this.alwaysShowCalendars) && this.container.addClass("show-calendar"), this.container.addClass("opens" + this.opens), this.container.find(".applyBtn, .cancelBtn").addClass(this.buttonClasses), this.applyButtonClasses.length && this.container.find(".applyBtn").addClass(this.applyButtonClasses), this.cancelButtonClasses.length && this.container.find(".cancelBtn").addClass(this.cancelButtonClasses), this.container.find(".applyBtn").html(this.locale.applyLabel), this.container.find(".cancelBtn").html(this.locale.cancelLabel), this.container.find(".drp-calendar").on("click.timedaterangepicker", ".prev", e.proxy(this.clickPrev, this)).on("click.timedaterangepicker", ".next", e.proxy(this.clickNext, this)).on("mousedown.timedaterangepicker", "td.available", e.proxy(this.clickDate, this)).on("mouseenter.timedaterangepicker", "td.available", e.proxy(this.hoverDate, this)).on("change.timedaterangepicker", "select.yearselect", e.proxy(this.monthOrYearChanged, this)).on("change.timedaterangepicker", "select.monthselect", e.proxy(this.monthOrYearChanged, this)).on("change.timedaterangepicker", "select.hourselect,select.minuteselect,select.secondselect,select.ampmselect", e.proxy(this.timeChanged, this)), this.container.find(".ranges").on("click.timedaterangepicker", "li", e.proxy(this.clickRange, this)), this.container.find(".drp-buttons").on("click.timedaterangepicker", "button.applyBtn", e.proxy(this.clickApply, this)).on("click.timedaterangepicker", "button.cancelBtn", e.proxy(this.clickCancel, this)), this.element.is("input") || this.element.is("button") ? this.element.on({
			"click.timedaterangepicker": e.proxy(this.show, this),
			"focus.timedaterangepicker": e.proxy(this.show, this),
			"keyup.timedaterangepicker": e.proxy(this.elementChanged, this),
			"keydown.timedaterangepicker": e.proxy(this.keydown, this)
		}) : (this.element.on("click.timedaterangepicker", e.proxy(this.toggle, this)), this.element.on("keydown.timedaterangepicker", e.proxy(this.toggle, this))), this.updateElement()
	};
	return a.prototype = {
		constructor: a,
		...
		renderCalendar: function(a) {
			...
			//Y += '<tr><td colspan="5"><span class="clstodaydate">'+moment().format("MMM D, YYYY")+'</span><span class="clstodaydatetxt">Today</span></td></tr>';
			// end here custome code
			for (b = 0; b < 6; b++) {
		...
		show: function(t) {
			this.isShowing || (this._outsideClickProxy = e.proxy(function(t) {
				this.outsideClick(t)
			}, this), e(document).on("mousedown.timedaterangepicker", this._outsideClickProxy).on("touchend.timedaterangepicker", this._outsideClickProxy).on("click.timedaterangepicker", "[data-toggle=dropdown]", this._outsideClickProxy).on("focusin.timedaterangepicker", this._outsideClickProxy), e(window).on("resize.timedaterangepicker", e.proxy(function(t) {
				this.move(t)
			}, this)), this.oldStartDate = this.startDate.clone(), this.oldEndDate = this.endDate.clone(), this.previousRightTime = this.endDate.clone(), this.updateView(), this.container.show(), this.move(), this.element.trigger("show.timedaterangepicker", this), this.isShowing = !0)
		},
		hide: function(t) {
			this.isShowing && (this.endDate || (this.startDate = this.oldStartDate.clone(), this.endDate = this.oldEndDate.clone()), this.startDate.isSame(this.oldStartDate) && this.endDate.isSame(this.oldEndDate) || this.callback(this.startDate.clone(), this.endDate.clone(), this.chosenLabel), this.updateElement(), e(document).off(".timedaterangepicker"), e(window).off(".timedaterangepicker"), this.container.hide(), this.element.trigger("hide.timedaterangepicker", this), this.isShowing = !1)
		},
		toggle: function(t) {
		...
		outsideClick: function(t) {
			var a = e(t.target);
			"focusin" == t.type || a.closest(this.element).length || a.closest(this.container).length || a.closest(".calendar-table").length || (this.hide(), this.element.trigger("outsideClick.timedaterangepicker", this))
		},
		showCalendars: function() {
			this.container.addClass("show-calendar"), this.move(), this.element.trigger("showCalendar.timedaterangepicker", this)
		},
		hideCalendars: function() {
			this.container.removeClass("show-calendar"), this.element.trigger("hideCalendar.timedaterangepicker", this)
		},
		...
		clickApply: function(t) {
			this.hide(), this.element.trigger("apply.timedaterangepicker", this)
		},
		clickCancel: function(t) {
			this.startDate = this.oldStartDate, this.endDate = this.oldEndDate, this.hide(), this.element.trigger("cancel.timedaterangepicker", this)
		},
		...
		remove: function() {
			this.container.remove(), this.element.off(".timedaterangepicker"), this.element.removeData()
		}
	}, e.fn.timedaterangepicker = function(t, i) {
		var s = e.extend(!0, {}, e.fn.timedaterangepicker.defaultOptions, t);
		return this.each(function() {
			var t = e(this);
			t.data("timedaterangepicker") && t.data("timedaterangepicker").remove(), t.data("timedaterangepicker", new a(t, s, i))
		}), this
	}, a
});
